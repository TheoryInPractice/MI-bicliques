...
/**
 * Test SearchTreeBagPlus::expand, failure condition in which
 * adding the expanded node makes completely_connect_in empty.
 */
int test_searchtreebagplus_expand_failure_empty_cc_in(int argc, char ** argv) {
